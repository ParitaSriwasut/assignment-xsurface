...
export default function SearchInput({ handleSearchInputChange, searchInput }) {
  return (
    <div className="sm:w-640 md:w-768 lg:w-1024 xl:w-1280 2xl:w-1536 mx-auto relative flex items-center justify-center pt-6 px-12 bg-white">
      <div className="absolute left-3 inset-y-0 flex items-center">
        <GrSearch className="relative flex text-2xl font-bold text-secondary-400" />
      </div>
      <input
