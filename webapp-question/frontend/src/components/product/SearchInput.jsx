...
export default function SearchInput({ handleSearchInputChange, searchInput }) {
  return (
    <div className="sm:w-640 md:w-768 lg:w-1024 xl:w-1280 2xl:w-1536 mx-auto flex items-center justify-center pt-6 px-12 relative bg-white">
      <div className="left-3 top-2 inset-y-0 flex items-center">
